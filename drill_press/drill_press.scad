...
// assert(2*base_plate_part_length -2*pipe_bearing_outer_diameter + 2*base_zipper_width == entire_rail_length_relative_to_pipe_center, "It all must fit together");
...
//         clearance = _clearance
//     );
//     back(62.5) right(41) yrot(180) xrot(-90) linear_bearings(selection=2, h=10, dInner=25, dOuter=35, dInnerLoose=26);
// }
